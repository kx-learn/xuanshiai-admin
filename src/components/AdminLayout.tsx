...
const groups: Group[] = [
  ...
  { label: "分店管理", icon: Store, items: [{ label: "分站配置", href: "/branch-config" }, { label: "门店管理", href: "/mendian-list" }, { label: "分店红娘", href: "/branch-matchmaker-list" }, { label: "分店报表", href: "/branch-report-list" }, { label: "分成明细", href: "/branch-distribuion-list" }] },
  ...
  { label: "合伙红娘", icon: Users, items: [{ label: "功能配置", href: "/love-partner-config" }, { label: "分成配置", href: "/love-partner-bonus-config" }, { label: "合伙人管理", href: "/love-partner-list" }, { label: "团队关系", href: "/love-partner-relation-manage" }, { label: "分成明细", href: "/love-partner-bonus-details" }] },
  { label: "活动报名", icon: CalendarDays, items: [{ label: "参数配置", href: "/active-config" }, { label: "活动管理", href: "/active-list" }, { label: "报名管理", href: "/active-signupmanager" }, { label: "互选活动", children: [{ label: "活动管理", href: "/mutual-selection-activities-list" }, { label: "互选记录", href: "/mutual-selection-activities-record" }] }] },
  ...
  { label: "运营工具", icon: LayoutGrid, items: [
    ...
    { label: "红娘喜讯", children: [{ label: "栏目配置", href: "/matchmaker-good-news-configuration" }, { label: "喜讯管理", href: "/matchmaker-good-news-manage" }, { label: "锦旗管理", href: "/matchmaker-good-news-pennant-manage" }] },
    { label: "搭子社群", children: [{ label: "栏目配置", href: "/column-configuration" }, { label: "社群管理", href: "/group-manage" }, { label: "报名管理", href: "/sign-manage" }] },
    { label: "互动消息", children: [{ label: "功能设置", href: "/interactive-messages-function" }, { label: "内容设置", href: "/interactive-messages-content" }, { label: "消息记录", href: "/interactive-messages-list" }] },
    { label: "销售匹配库", href: "/sales-library" },
    ...
    { label: "推广管理", href: "/vip-popularize-record" },
