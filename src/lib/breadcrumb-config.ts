...
const groups: Record<string, { label: string; href: string; children: { label: string; href: string }[] }> = {
  ...
  loveMatchmaker: { label: "总店红娘", href: "/love-matchmaker-apportion2", children: [{ label: "分派配置", href: "/love-matchmaker-apportion2" }, { label: "分成明细", href: "/love-matchmaker-distribution-details" }] },
};
