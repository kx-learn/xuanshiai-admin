            ...
            <div className="pl-pane">
                  ...
                  <div className="pl-navbar-row" key={it.key}>
                    ...
                    {it.category && (
                      <span className="pl-dropdown">
                        <select defaultValue="选择活动分类" className="pl-dropdown-select">
              ...
              <div className="pl-block">
                ...
                <div className="pl-stat-inputs">
                  {(["男嘉宾数", "女嘉宾数", "本月新加入数", "成功脱单数"] as const).map((lab, i) => (
                    <div className="pl-stat-field" key={lab}>
                      <span className="pl-stat-label">{lab}</span>
                      <input className="nv-input pl-stat-num" defaultValue={["12987", "8679", "280", "520"][i]} />
                    </div>
                  ))}
                </div>
                <div className="pl-tip">
              ...
              <div className="pl-submit"><button type="button" className="nv-ok-btn pl-submit-btn">确定提交</button></div>
            </div>
          )}
